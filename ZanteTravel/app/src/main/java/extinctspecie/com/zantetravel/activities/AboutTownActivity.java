...
public class AboutTownActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_dialog_about);
    ...
    private void loadHtmlToWebView() {
        ((WebView) findViewById(R.id.wvAbout)).loadData("<p align=\"center\">&nbsp;</p>\n" +
                "<p align=\"center\">&nbsp;</p>\n" +
        ...
        ((WebView) findViewById(R.id.wvAbout)).getSettings().setTextZoom(80);
    }
